...
if not BASE_URL:
    BASE_URL = "https://test-suite-green.preview.emergentagent.com"
...
class TestExecutionStatus:
    ...
    def test_execution_status_returns_sprints(self, auth_session):
        ...
        assert sprints["sprint_1"]["phases"] == 4, "Sprint 1 should have 4 phases"
        assert sprints["sprint_2"]["phases"] == 1, "Sprint 2 should have 1 phase"
        assert sprints["sprint_3"]["phases"] == 5, "Sprint 3 should have 5 phases"
