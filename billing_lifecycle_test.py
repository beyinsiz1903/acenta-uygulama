...
# Configuration
BASE_URL = "https://enterprise-dashboard-10.preview.emergentagent.com"
...
class BillingTester:
    ...
    def test_customer_portal_endpoint(self, token: str):
        ...
        portal_data = {
            "origin_url": "https://enterprise-dashboard-10.preview.emergentagent.com/app/settings/billing",
