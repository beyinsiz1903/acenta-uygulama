    ...
    <div className="space-y-6" data-testid="admin-match-alerts-policy-page">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 mt-2" data-testid="match-risk-risk-profile-card">
            ...
            <div className="space-y-1">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Sadece doğrulanmış (verified) modu, yalnızca doğrulanmış rezervasyon sayısı bu değerden büyük veya eşit ise aktif olur.
              </p>
            </div>
          </div>
      ...
      <Card className="mt-4">
            ...
            <CardContent className="space-y-3">
              <p className="text-xs text-muted-foreground">
                Yüksek risk tanımı: <code>behavioral_not_arrived_rate &gt;= rate_threshold</code> VEYA
                <code> repeat_not_arrived_7 &gt;= repeat_threshold_7</code>. Tüm dashboard, uyarı (alert) ve dışa aktarma
                özellikleri bu profile göre hesaplanır.
              </p>
