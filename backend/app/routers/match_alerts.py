...
async def get_risk_profile(db=Depends(get_db), user=Depends(get_current_user)):
    ...
    return RiskProfileResponse(
        ...
        risk_profile=RiskProfileOut(
            ...
            mode=rp.mode,
            no_show_rate_threshold=rp.no_show_rate_threshold,
            repeat_no_show_threshold_7=rp.repeat_no_show_threshold_7,
            min_verified_bookings=rp.min_verified_bookings,
            prefer_verified_only=rp.prefer_verified_only,
            updated_at=None,
