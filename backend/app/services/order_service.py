...
async def get_order_by_id(order_id: str) -> Optional[dict]:
    ...
    order["financial_summary"] = {
        ...
        "financial_status": order.get("financial_status", "not_posted"),
        "ledger_posting_refs": order.get("ledger_posting_refs", []),
        "ledger_posting_count": len(order.get("ledger_posting_refs", [])),
        "settlement_run_refs": order.get("settlement_run_refs", []),
        "settlement_run_count": len(order.get("settlement_run_refs", [])),
