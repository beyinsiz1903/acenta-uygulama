...
class TestPMSAuthentication:
    ...
    def test_login_with_agency_credentials(self, api_client):
        ...
        print(f"PASS: Agency login successful")
    ...
    def test_pms_dashboard_requires_auth(self, api_client):
        ...
        print(f"PASS: PMS dashboard requires authentication")
...
class TestPMSDashboard:
    ...
    def test_dashboard_with_hotel_filter(self, authenticated_client):
        ...
        if data.get("hotels") and len(data["hotels"]) > 0:
            ...
            print(f"PASS: Dashboard with hotel filter works")
        else:
            print(f"SKIP: No hotels available to test filter")
...
class TestPMSArrivals:
    ...
    def test_get_arrivals(self, authenticated_client):
        ...
        if data["items"]:
            ...
            print(f"PASS: Arrival item structure validated")
...
class TestPMSReservations:
    ...
    def test_get_reservations_with_filters(self, authenticated_client):
        ...
        print(f"PASS: Reservations with limit filter works")
...
class TestPMSRooms:
    ...
    def test_create_room(self, authenticated_client):
        ...
        if response.status_code == 409:
            print(f"PASS: Room create handles duplicate correctly (409)")
            return None
    ...
    def test_delete_test_room(self, authenticated_client):
        ...
        if not test_room:
            print(f"SKIP: No TEST_999 room found to delete")
            return
        ...
        print(f"PASS: Test room TEST_999 deleted successfully")
...
class TestPMSCheckInOut:
    ...
    def test_check_in_reservation(self, authenticated_client):
        ...
        if not candidate:
            print(f"SKIP: No reservation available for check-in test")
            return
        ...
        if check_in_response.status_code == 409:
            print(f"PASS: Check-in handles already checked-in reservation correctly (409)")
    ...
    def test_check_out_reservation(self, authenticated_client):
        ...
        if not in_house:
            print(f"SKIP: No in-house guests available for check-out test")
            return
        ...
        if not candidate:
            print(f"SKIP: No reservation available for check-out test")
            return
        ...
        if check_out_response.status_code == 409:
            print(f"PASS: Check-out handles edge case correctly (409)")
