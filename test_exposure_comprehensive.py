...
def test_exposure_page_comprehensive():
    ...
    print("\nStep 1: Admin login")
    login_url = "https://saas-partner.preview.emergentagent.com/api/auth/login"
    login_data = {
    ...
    exposure_url = "https://saas-partner.preview.emergentagent.com/api/ops/finance/exposure"
    headers = {
    ...
    login_page_url = "https://saas-partner.preview.emergentagent.com/login"
    try:
        ...
        exposure_page_url = "https://saas-partner.preview.emergentagent.com/app/admin/finance/exposure"
