...
def setup_marketplace_infrastructure(org_id: str, test_suffix: str):
...
def test_mock_adapter_happy_path():
    ...
    try:
        ...
        infra = setup_marketplace_infrastructure(org_id, "mock_happy")
...
def test_credit_limit_guard():
    ...
    try:
        ...
        infra = setup_marketplace_infrastructure(org_id, "credit_limit")
...
def test_supplier_unresolved():
    ...
    try:
        # 1. Setup marketplace infrastructure
        print("1️⃣  Setting up marketplace infrastructure...")
        infra = setup_marketplace_infrastructure(org_id, "unresolved")
...
def test_paximum_not_supported():
    ...
    try:
        # 1. Setup marketplace infrastructure
        print("1️⃣  Setting up marketplace infrastructure...")
        infra = setup_marketplace_infrastructure(org_id, "paximum")
...
def test_adapter_error_propagation():
    ...
    try:
        # 1. Setup marketplace infrastructure
        print("1️⃣  Setting up marketplace infrastructure...")
        infra = setup_marketplace_infrastructure(org_id, "error_prop")
...
def test_pr16_regression():
    ...
    try:
        ...
        infra = setup_marketplace_infrastructure(org_id, "pr16_regression")
        email = f"agency_admin_{uuid.uuid4().hex[:8]}@test.com"
        token = create_agency_admin_user_and_login(org_id, email)
