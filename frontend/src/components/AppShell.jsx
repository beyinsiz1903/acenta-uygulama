...
export default function AppShell() {
  ...
  const panelLabel = isAgency ? "Agency Paneli" : isHotel ? "Hotel Paneli" : "Admin Paneli";
              ...
              {roleBasedMenu.map((section) => (
                <div key={section.label} className="mb-3 last:mb-0">
                  ...
                  {section.children.map((item) => {
                    // Simple feature gating for hotel menu items
                    if (item.featureKey && user?.hotel_package !== "channel") {
                      return null;
                    }
