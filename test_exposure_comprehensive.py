...
def test_exposure_page_comprehensive():
    ...
    login_page_url = "https://redis-cache-upgrade.preview.emergentagent.com/login"
    try:
        ...
        exposure_page_url = "https://redis-cache-upgrade.preview.emergentagent.com/app/admin/finance/exposure"
