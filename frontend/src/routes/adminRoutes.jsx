...
const TourVisioTestPage = lazy(() => import("../pages/admin/TourVisioTestPage"));
...
const MarketplaceContractsPage = lazy(() => import("../pages/syroce/MarketplaceContractsPage"));
...
export const adminRoutes = (
  <>
    ...
    <Route path="tourvisio-test" element={<TourVisioTestPage />} />
    ...
    <Route path="syroce-marketplace/contracts" element={<MarketplaceContractsPage />} />
