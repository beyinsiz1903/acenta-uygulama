...
def check_admin_roles():
    ...
    try:
        ...
        response = requests.get("https://agency-analysis-1.preview.emergentagent.com/api/auth/me", headers=headers, timeout=10)
        if response.status_code == 200:
        ...
        for params in test_params:
            url = f"https://agency-analysis-1.preview.emergentagent.com/api/ops/bookings{params}"
            print(f"\nTesting: {url}")
